class MouseSwitch
  ...
  trayicon=GdkPixbuf::Pixbuf.new :file => File.dirname(__FILE__) + '/TrayIcon.png'
  ...
  @@lefthanded.image=Gtk::Image.new(:file => File.dirname(__FILE__) +'/check.png')
  @@righthanded.image=Gtk::Image.new(:file => File.dirname(__FILE__) +'/check.png')
